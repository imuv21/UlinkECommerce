      ...
      <div className='adminpage'>
        ...
        <div className='perfect-grid-admin' ref={numberRef}>
          <div className="grid-item-admin">
            ...
            <div className="orderdisicon">
              <svg xmlns="http://www.w3.org/2000/svg" className='order-icon-svg' viewBox="0 0 24 24"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"><path d="M12 15.333c1.105 0 2-.746 2-1.666S13.105 12 12 12s-2-.746-2-1.667c0-.92.895-1.666 2-1.666m0 6.666c-1.105 0-2-.746-2-1.666m2 1.666V16m0-8v.667m0 0c1.105 0 2 .746 2 1.666"></path><path d="M17 3.338A9.95 9.95 0 0 0 12 2C6.477 2 2 6.477 2 12c0 1.6.376 3.112 1.043 4.453c.178.356.237.763.134 1.148l-.595 2.226a1.3 1.3 0 0 0 1.591 1.592l2.226-.596a1.63 1.63 0 0 1 1.149.133A9.96 9.96 0 0 0 12 22c5.523 0 10-4.477 10-10c0-1.821-.487-3.53-1.338-5"></path></g></svg>
            </div>
          </div>
          <div className="grid-item-admin">
            <div className="orderdis">
        ...
        <div className="admin-orders">
          ...
          <div className="admin-order-title">
            ...
            <div className="order-list-box">
              <div className="descrip">Created at</div>
            </div>
            <div className="order-list-box">
              <div className="descrip">Customer</div>
            </div>
            <div className="order-list-box">
              <div className="descrip">Priority</div>
            </div>
            <div className="order-list-box">
              <div className="descrip">Total</div>
            </div>
            <div className="order-list-box">
              <div className="descrip">Payment Status</div>
            </div>
            <div className="order-list-box">
              <div className="descrip">Items</div>
            </div>
            <div className="order-list-box">
            ...
            <div className="order-list-box">
              <div style={{ backgroundColor: 'rgb(255, 255, 159)' }}>< VisibilityIcon style={{ color: 'rgb(233, 218, 0)' }} /></div>
              <div style={{ backgroundColor: 'rgb(164, 255, 159)' }}>< BorderColorIcon style={{ color: 'rgb(12, 233, 0)' }} /></div>
              <div style={{ backgroundColor: 'rgb(255, 188, 159)' }}>< DeleteIcon style={{ color: 'rgb(250, 47, 47)' }} /></div>
            </div>
          </div>
