    ...
    return (
        <Fragment>
            ...
            <article className="flexcol wh home-alt">
                <h1 className="heading5" style={{ textAlign: 'center', width: '80%', color: 'var(--CodeTwo)' }}>Trade with confidence: We are backed by the Indian Government and strategically located in India (Delhi).</h1>
            ...
            <article className="flexcol wh home-alt">
                ...
                <div className="perfect-grid2" style={{ gap: '8%' }}>
                    <section className='flexcol' style={{ gap: '20px' }}>
                        ...
                        <p className="descrip"> Tamron, General Manager, Dubai</p>
                    </section>
                    <section className='flexcol' style={{ gap: '20px' }}>
                        <div className="photo">
                            <img src={three} alt="three" />
                        ...
                        <p className="descrip"> Asante General Trading, Dubai</p>
                    </section>
                </div>
            </article>
            ...
            <article className="flexcol wh home-alt" style={{ backgroundColor: 'var(--bgClr)' }}>
                ...
                <div className="flexcol wh">
                    ...
                    <section className={`accordion-pd ${activeIndex === 4 ? 'active' : ''}`} onClick={() => toggleAccordion(4)}>
                        <div className='flex' style={{ gap: '20px' }}>
                            <HelpCenterIcon />
                            <h1 className="heading2">What is the benefit of being verified as a Seller?</h1>
                        </div>
                    </section>
