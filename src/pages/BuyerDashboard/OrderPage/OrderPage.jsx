            ...
            <div className='filter-Option '>
                <div className='filter-border-1'>
                    ...
                    <form onSubmit={handleClearFilter}>
                        <div className='filter-option'>
                            <lebel className='paragraph-6'>Search by order number</lebel><br></br>
                        ...
                        <div className='filter-option'>
                            <lebel className='paragraph-6'>Order status
                            </lebel><br></br>
                        ...
                        <div className='filter-option'>
                            <lebel className='paragraph-6'>Payment Status
                        ...
                        <div className='filter-option'>
                            <lebel className='paragraph-6'>Payment Methode
                            </lebel><br></br>
                        ...
                        <div className='filter-option'>
                            <lebel className='paragraph-6'> Sort By
                            </lebel><br></br>
