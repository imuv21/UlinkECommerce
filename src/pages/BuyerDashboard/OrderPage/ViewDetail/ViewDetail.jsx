        ...
        <div className='background-Changer'>
          <div className='card-methodes'>
            ...
            <div>
              ...
              <p className='dis  pt '>Thank you for buying from Ulinkit Outsource Pvt Ltd.</p>
            ...
            <div className='invoice-border'>
              <div className='invoice-flex dis '>
                ...
                <div >
                  ...
                  <p className='mt-top'>Vipin Kumar</p>
                  <p className='mt-top'>Ulinkit Outsource Pvt Ltd.</p>
                </div>
              </div>
            </div>
            ...
            <div className='mt-top flex-end'>
              <p className='bold'>Grand Total: $215.00</p>
            </div>
            <div className=' mt-top-2 sharing-info'>
              <p className='mt-top'> <b>Thanks for buying on Ulinkit Marketplace.</b> To provide feedback for the seller please visit <a href=''>http://localhost:5173/</a> To
      ...
      <div className='mt '>
        <div className='flex-space-beetwen position'>
          <div className='message-titles-heading1 flex mr-left'>
            <h1 className='user-title  heading-2 '>Order <span>ULINK56565641</span></h1>
            <p className=' ml-left   quotes'>Cancelled</p>
          </div>
          <div className='message-titles-heading1 flex    '>
            <button className='create-btn btn-change  ' onClick={handleInvoice}>DOWNLOAD INVOICES</button>
          </div>
        </div>
        ...
        <div className='list-item  order-statuses bor-1 list-item-status'>
          <div className='item-lists'>
            ...
            <p>2024 Mobile Phones A14 pro max 6.8Inches 16GB+1TB phone 4G Smartphone Unlock Android Blue,16g x5</p>
          </div>
          <div className='item-list'>
        ...
        <div className='order-statuses bor-1 mr-top'>
          <div className='shippingAddress shippingAddresses'>
            ...
            <div className='d-flex table'>
              <div className='d-flex'>
                <p>System</p>
                <p className='dis paragraph-4'>"2024 Mobile Phones A14 pro max 6.8Inches 16GB+1TB phone 4G Smartphone Unlock Android Blue,16g" status changed to<br></br> Canceled
