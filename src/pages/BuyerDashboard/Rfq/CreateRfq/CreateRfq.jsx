...
const CreateRfq = () => {
    ...
    const handleSubmitRfq = (e) => {
        ...
        navigate('/reviewconfirm', { state: { addproduct, shippingData, updateadditonalDetail, getCountry, selectedState, cities } })
    }
    return (
        <>
            {uploadFile && (
                ...
                <div className='border-1 border-p '>
                    <form onSubmit={handleSubmitRfq}>
                        ...
                        <div className='add-card-btn subcanc'>
                            <button className='add-bank-btn cancel' >Cancel</button>
                            <button type='submit' className='add-bank-btns cancel'  >SUBMIT RFQ</button>
                        </div>
                    </form>
                </div>
            </div>
