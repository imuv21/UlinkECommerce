...
import three from '../assets/jpg-slider/3.jpg';
import HelpCenterIcon from '@mui/icons-material/HelpCenter';
import Amazon from '../assets/Amazon_Global_Selling_Logo.png';
import Dpworld from '../assets/dpworld.png';
import Amazon2 from '../assets/amazon.png';
            ...
            <div className="flexcol wh home" style={{ gap: '60px', backgroundColor: 'var(--bgClr)' }}>
                ...
                <div className="flexcol wh" style={{ gap: '20px' }}>
                    ...
                    <div className="perfect-grid2 trade">
                        ...
                        <div><img src={Amazon2} className='grid-icon' alt="logo" /></div>
                    </div>
                </div>
            </div>
