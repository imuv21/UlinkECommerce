...
//                       <input className='pminput' type="number" value={quantities[item.productId] || item.minOrderQuant} onChange={(e) => handleInputChange(e, item.productId, item.minOrderQuant)} />
